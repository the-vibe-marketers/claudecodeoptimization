...
alias cc-haiku="claude-code --model claude-haiku-4-5-20251001"
alias cc-plan="claude-code --ask-for-plan"
EOF
    echo -e "${GREEN}✓ Added aliases to $shell_name config${NC}"
    echo "  Use: cc-budget, cc-reset, cc-optimize, cc-sonnet, cc-haiku, cc-plan"
else
...
echo "  • This setup is GLOBAL - applies to ALL your projects"
echo "  • Budget is shared across all projects"
echo "  • If using Claude subscription: use 'cc-haiku' to force Haiku model"
echo ""
echo -e "${BLUE}How to Use Claude Code:${NC}"
echo "  • API users: Just type 'claude' (Haiku is default)"
echo "  • Subscription users: Type 'cc-haiku' to use Haiku, or 'claude' for your default"
echo ""
echo -e "${YELLOW}Next Steps:${NC}"
echo "  1. Reload your shell: source $shell_config"
echo "  2. Test it: claude-code /budget"
echo "  3. Start coding: cc-haiku (for Haiku) or claude (for default)"
echo "  4. Read more: https://github.com/the-vibe-marketers/claudecodeoptimization"
echo ""
echo -e "${BLUE}Quick Commands:${NC}"
echo "  • cc-haiku      → Force Haiku model for this session"
